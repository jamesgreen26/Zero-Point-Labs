...
public class StairGenerator {
        ...
        String json = """
                {
                  "variants": {
                    "facing=east,half=bottom,shape=inner_left": {
                      "model": "zpl:block/%1$s_stairs_inner",
                      "uvlock": true,
                      "y": 270
                    },
                    ...
                    "facing=east,half=bottom,shape=outer_left": {
                      "model": "zpl:block/%1$s_stairs_outer",
                      "uvlock": true,
                      "y": 270
                    },
              ...
              """.formatted(name);
        String path = BlockDataGenerator.FOLDER + "assets/zpl/blockstates/" + name + "_stairs.json";
    ...
    private static void generateRegularModel(String name) {
        String json = """
              ...
              """.formatted(name);
        String path = BlockDataGenerator.FOLDER + "assets/zpl/models/block/" + name + "_stairs.json";
    ...
    private static void generateOuterModel(String name) {
        String json = """
              ...
              """.formatted(name);
        String path = BlockDataGenerator.FOLDER + "assets/zpl/models/block/" + name + "_stairs_outer.json";
    ...
    private static void generateInnerModel(String name) {
        String json = """
              ...
              """.formatted(name);
        String path = BlockDataGenerator.FOLDER + "assets/zpl/models/block/" + name + "_stairs_inner.json";
