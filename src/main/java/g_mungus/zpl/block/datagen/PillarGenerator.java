...
public class PillarGenerator {
    ...
    private static void generatePillarModel(String name) {
        String json = """
              ...
              """.formatted(name);
        String path = BlockDataGenerator.FOLDER + "assets/zpl/models/block/" + name + "_pillar.json";
    ...
    private static void generateBlockState(String name) {
        String json = """
              ...
              """.formatted(name);
        String path = BlockDataGenerator.FOLDER + "assets/zpl/blockstates/" + name + "_pillar.json";
    ...
    private static void generateLootTable(String name) {
        String json = """
              ...
              """.formatted(name);
        String path = BlockDataGenerator.FOLDER + "data/zpl/loot_tables/blocks/" + name + "_pillar.json";
